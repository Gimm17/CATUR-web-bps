  ...
  return (
    <nav className="main-header navbar navbar-expand navbar-white navbar-light sensus-navbar">
      ...
      <ul className="navbar-nav">
        ...
        {isMobile && (
          <li className="nav-item brand-mobile">
            <div className="nav-link brand-container">
              <div className="brand-text">
                <span className="brand-title">CATUR</span>
                <span className="brand-subtitle">Control Activity & Time Use Record</span>
              </div>
            </div>
          </li>
        )}
        
        {/* Current Date Display - Hidden on mobile */}
        {!isMobile && (
        ...
        {/* Search Bar dengan Results - Hidden on mobile */}
        {!isMobile && (
          <li className="nav-item">
              ...
              <>
                <li className="dropdown-header">
                  ...
                  <div className="user-role-badge-nav">
                    <span className={`badge ${user.role}`}style={{ color: 'gray' }}>
                      {user.role === 'admin' ? 'Administrator' : 
                       user.role === 'atasan' ? 'Atasan' : 
                       user.role === 'keuangan' ? 'Keuangan' : 
                       'Pegawai'}
